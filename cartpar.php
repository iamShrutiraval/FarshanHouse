...
<body>
    <div class="crt">
        ...
        then after the while : 
            #code localStorage.setItem("cart_name",stringified_cart_id); -->

        <!-- for checkout btn use anchor tag & with query string ? containing checkout status = 1 -->

        <!-- in checkout page -- if checkout status = 1 {use localstorage array
...
console.log(username); // "John Doe" }
 -->
            ...
            <tr id="<?php echo $cart_row['cart_id'];?>">
                <td>
                    <div class="crtinfo">
                            <img src="assets/img/<?=$Product_row['pro_img']?>" alt="<?=$Product_row['pro_name']?>"
                                style="width:20%">
                        <p>
                            <?= $Product_row['pro_name']?>
                        </p>
                        <small><br> Price :
                            <?=$Product_row['pro_price'] ?> Rs.
                        </small>
                        <br>
                ...
                <td>
                    <input type="hidden" name="pro_price" value="<?=$Product_row['pro_price']; ?>">
                    <select id="weight<?=$cart_row['cart_id']; ?>" name="weight[]" class="weight"
                        ...
                        <option class="text-start" value="1000" selected>1 Kg</option>
                    </select>
                ...
                <td>
                    ...
                    <input id="q<?php echo $cart_id; ?>" name="pro_qty" type="text"
                        value="<?php if(isset($_POST['pro_qty']) && $cart_id==$_POST['cart_id']){ echo $_POST['pro_qty'];}else{ echo '1';}?>">
                    
                    <button type="button" id="dicri_<?php echo $cart_row['cart_id']; ?>"
...
?>
    ...
    <button type="submit" class="btn btn-dark text-light" name="checkout"><a href="checkout.php">Checkout</a></button>
