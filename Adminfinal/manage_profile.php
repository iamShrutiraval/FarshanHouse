...
session_start();
    $cemail=$_SESSION['Role'];
    // echo $first=$_SESSION['firstname'];
$qry="Select *from admin where email = '$cemail' ";
                                ...
                                <div class="container-xl px-4 mt-4">
                                    ...
                                    <!-- <div class="row"> -->
                                        ...
                                        <div class="col-xl-8">
                                            ...
                                            <div class="card mb-4">
                                                <div class="card-header">Admin Login Details</div>
                                                <div class="card-body">
                                                    ...
                                                    <form action="#" method="POST">
                                                        ...
                                                        <div class="row gx-3 mb-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label class="small mb-1" for="inputFirstName">First
                                                                    name</label>
                                                                <input class="form-control" id="first" name="first"
                                                                    type="text" placeholder="Enter your first name" value="<?php echo $fname;?>">
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input class="form-control" id="last" name="last"
                                                                    type="text" placeholder="Enter your last name" value="<?php echo $lname;?>">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" id="inputEmailAddress"
                                                                type="email" name="email" placeholder="Enter your email address" value="<?php echo $email;?>">
                                                        </div>
                                                        ...
                                                        <!-- Form Row-->
                                                        <!-- Save changes button-->
                                                        <button class="btn btn-primary" type="button" name="save">Save
                                                            changes</button>
                                                    </form>
                                                </div>
                                            </div>
...
if(isset($_POST['save']))
{
    ...
    $qry2="UPDATE `admin` SET `first_name` = '$first',`last_name` = '$last' WHERE `email` = '$nemail';";
